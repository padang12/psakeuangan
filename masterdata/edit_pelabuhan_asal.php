...
$query = mysqli_query($koneksi,"SELECT * FROM tb_pelabuhan_asal where id='$id'");
...
if(isset($_POST['submit'])) {
  ...
  if($cekuraian > 0) {
    ...
    mysqli_query($koneksi, "UPDATE tb_pelabuhan_asal set nama_pelabuhan='$nama_pelabuhan' where id='$id'");
    ?> 
    <SCRIPT> 
